...
class Template_de_imposto_condicional(Imposto):
	...
	def calcula(self, orcamento):
		if self.deve_usuar_maxima_taxacao(orcamento):
	...
	@abstractmethod
	def deve_usuar_maxima_taxacao(self, orcamento): pass
...
class ICPP(Template_de_imposto_condicional):
	...
	def deve_usuar_maxima_taxacao(self, orcamento):
...
class IKCV(Template_de_imposto_condicional):
	...
	def deve_usuar_maxima_taxacao(self, orcamento):
		return orcamento.valor and self.__tem_item_maior_que_cem_reais(orcamento)
